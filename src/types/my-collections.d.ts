...
export interface paths {
  ...
  "/items/buttons": {
    /**
     * List Items
     * @description List the buttons items.
     */
    get: operations["readItemsButtons"];
    /**
     * Create an Item
     * @description Create a new buttons item.
     */
    post: operations["createItemsButtons"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing buttons items.
     */
    delete: operations["deleteItemsButtons"];
    /**
     * Update Multiple Items
     * @description Update multiple buttons items at the same time.
     */
    patch: operations["updateItemsButtons"];
  };
  "/items/buttons/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single buttons item by unique identifier.
     */
    get: operations["readSingleItemsButtons"];
    /**
     * Delete an Item
     * @description Delete an existing buttons item.
     */
    delete: operations["deleteSingleItemsButtons"];
    /**
     * Update an Item
     * @description Update an existing buttons item.
     */
    patch: operations["updateSingleItemsButtons"];
  };
  "/items/pages": {
    /**
     * List Items
  ...
  "/items/site": {
    ...
    /**
     * Delete Multiple Items
     * @description Delete multiple existing site items.
     */
    delete: operations["deleteItemsSite"];
    /**
     * Update Multiple Items
     * @description Update multiple site items at the same time.
     */
    patch: operations["updateItemsSite"];
  };
  "/items/site/{id}": {
    /**
     * Retrieve an Item
...
export interface components {
  schemas: {
    ...
    ItemsPagesBlocks: {
      ...
      item?: ((string | components["schemas"]["ItemsBlockHero"])[]) | null;
    ...
    ItemsSite: {
      ...
      /** @description Select the page which acts as the home page */
      home_page?: number | components["schemas"]["ItemsPages"] | null;
    };
    ItemsBlockHero: {
      id?: number;
      ...
      button?: number | components["schemas"]["ItemsButtons"] | null;
...
export interface operations {
  ...
  readItemsButtons: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsButtons"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsButtons: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsButtons"][] | components["schemas"]["ItemsButtons"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsButtons: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsButtons"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type MyCollections = {
  meta: components["schemas"]["ItemsMeta"][];
  buttons: components["schemas"]["ItemsButtons"][];
  pages: components["schemas"]["ItemsPages"][];
  pages_blocks: components["schemas"]["ItemsPagesBlocks"][];
  site: components["schemas"]["ItemsSite"][];
